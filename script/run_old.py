        ...
        for epoch in range(i, min(cfg.train.num_epoch, i + step)):
            ...
            for j in range(len(train_loaders)):
                ...
                for batch in train_loader:
                    ...
                    # print("binary_cross_entropy_with_logits loss: ", loss)
...
def test(cfg, model, test_data, filtered_data=None):
    ...
    # print("all ranking: ", all_ranking)
    # print("all ranking shape: ", all_ranking.shape)
    if rank == 0:
...
if __name__ == "__main__":
    ...
    # This is only true in ecommerce dataset though, cause relations in train/valid/test are the same
